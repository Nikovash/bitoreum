...
Crystal Bitoreum Core attempts to minimize the level of trust in DNS seeds,
but DNS seeds still pose a small amount of risk for the network.
As such, DNS seeds must be run by entities which have some minimum
level of trust within the Crystal Bitoreum community.

Other implementations of Crystal Bitoreum software may also use the same
...
functioning Crystal Bitoreum nodes from the public network to the best of the
...
for the operation of the service or urgent health of the Crystal Bitoreum
...
discontinue providing services and contact the active Crystal Bitoreum
...
- [bitoreum-seeder](<!--TODO-->) is a reference implementation of a DNS seed.