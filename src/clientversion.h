...
#error Client version information missing: version is not defined by bitoreum-config.h or in any other way
#endif
...
/**
 * bitoreumd-res.rc includes this file, but it cannot cope with real c++ code.
