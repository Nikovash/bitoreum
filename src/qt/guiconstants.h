...
/* BitoreumGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* BitoreumGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_APP_NAME_REGTEST "Bitoreum-Qt-regtest"
