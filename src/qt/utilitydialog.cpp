    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  bitoreum-qt [command-line options]                     \n";
...
All the Bitoreum in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 BTRM, 0.01 BTRM, 0.1 BTRM, 1 BTRM and 10 BTRM -- sort of like the paper money you use every day.</li> \
