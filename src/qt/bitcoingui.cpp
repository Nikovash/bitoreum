...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a Bitoreum address"));
    sendCoinsMenuAction->setToolTip(sendCoinsMenuAction->statusTip());

    coinJoinCoinsMenuAction = new QAction("&CoinJoin", this);
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a Bitoreum address").arg("CoinJoin"));
    coinJoinCoinsMenuAction->setToolTip(coinJoinCoinsMenuAction->statusTip());

    receiveCoinsMenuAction = new QAction(tr("&Receive"), this);
    receiveCoinsMenuAction->setStatusTip(tr("Request payments (generates QR codes and bitoreum: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about Bitoreum Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bitoreum addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bitoreum addresses"));
    ...
    openRepairAction = new QAction(QIcon(":/icons/configure"), tr("Wallet &Repair"), this);
    ...
    openAction->setStatusTip(tr("Open a bitoreum: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/configure"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Bitoreum command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (fNetworkActive) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitoreum network", "", count));
    } else {
...
void BitcoinGUI::updateWidth()
{
    ...
    // Use nButtonsVisible + 1 <- for the bitoreum logo
...
{
    QString strTitle = tr("Bitoreum Core"); // default title
