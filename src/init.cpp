...
public:
    ...
    // Bitoreum Specific WalletInitInterface InitCoinJoinSettings
 ...
 * between bitoreumd, and bitoreum-qt and non-server tools.
*/
...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-sporkaddr=<bitoreumaddress>", "Override spork address. Only useful for regtest and devnet. Using this on mainnet or testnet will ban you.", false, OptionsCategory::DEBUG_TEST);
    ...
    gArgs.AddArg("-platform-user=<user>", "Set the username for the \"platform user\", a restricted user intended to be used by Bitoreum Platform, to the specified username.", false, OptionsCategory::SMARTNODE);
...
bool AppInitMain()
{
    ...
    // ********************************************************* Step 10c: schedule Bitoreum-specific tasks
