...
public:
    CMainParams() {
        ...
        consensus.nProtocolUpgradeBlock = 834000;
      ...
      //FindMainNetGenesisBlock(1648947907, 0x20001fff, "main");
        ...
        // Bitoreum script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Bitoreum private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Bitoreum BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Bitoreum BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Bitoreum BIP44 coin type is '5'
...
public:
    CTestNetParams() {
        ...
        chainTxData = ChainTxData{
            1648954089, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
