...
if [ "$uname_S" = "Darwin" ]; then
    PARAMS_DIR="$HOME/Library/Application Support/BitoreumParams"
else
    PARAMS_DIR="$HOME/.bitoreum-params"
fi
...
Failed to fetch the Bitoreum parameters!
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Bitoreum SNARK parameters. Note that it is
