...
rm -f src/config/bitoreum-config.h
...
rm -rf test_bitcoin.coverage/ bitoreum-gtest.coverage/ total.coverage/
...
clean_exe src/bitoreum-cli
clean_exe src/bitoreumd
clean_exe src/bitoreum-gtest
clean_exe src/bitoreum-tx
clean_exe src/test/test_bitoreum
clean_exe src/test/test_bitoreum_fuzzy
