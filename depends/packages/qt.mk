...
$(package)_patches=fix_qt_pkgconfig.patch mac-qmake.conf fix_configure_mac.patch fix_no_printer.patch fix_rcc_determinism.patch xkb-default.patch no-xlib.patch qt_gcc11.patch fix_mingw_touchinput_redefinition.patch fix_libpng_fp_h_macos.patch fix_xcb_atoms_stdio_include.patch
...
define $(package)_preprocess_cmds
  ...
  patch -p1 -i $($(package)_patch_dir)/fix_mingw_touchinput_redefinition.patch &&\
  patch -p1 -i $($(package)_patch_dir)/fix_libpng_fp_h_macos.patch &&\
  patch -p1 -i $($(package)_patch_dir)/fix_xcb_atoms_stdio_include.patch &&\
