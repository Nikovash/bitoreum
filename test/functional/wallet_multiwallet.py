...
Verify that a bitoreumd node can load multiple wallet files
"""
import os
import re
import shutil
...
class MultiWalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        exp_stderr = "filesystem::create_directory: (The system cannot find the path specified|Not a directory):"
